...
final class Purchased: Notify {
    ...
    init() {
        ...
        let image = NSImageView(image: .init(systemSymbolName: "cloud", accessibilityDescription: nil) ?? .init())
